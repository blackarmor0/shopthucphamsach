            ...
            <table class="table table-responsive">
                ...
                <tbody>
                    ...
                    <tr data-expanded="true">
                        ...
                        <td><img src="{{asset($product->AVATA_SP)}}" style="max-width: 200px; height: 100px;"
                        ...
                        <td>
                            <a class="btn btn-primary" href="{{url('admin/product/edit/'.$product->MA_SP)}}">
                                <i class="bi-pencil"></i>
                            </a>
                        </td>
                        <td>
                            <form action="{{url('admin/xoa-san-pham/'.$product->MA_SP)}}" method="POST">
                                @csrf
                                {{-- @method('DELETE') ; --}}
