            ...
            <div class="position-center">
                <form role="form" action="{{ URL::TO('/admin/them-san-pham') }}" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" maxlength="5000" name="mota_sp" rows="15" style="max-width: 100%;"
                            ...
                            <table class="table table-active ">
                                ...
                                <tbody>
                                    ...
                                    <tr class="ttct" data-value="{{ $ttct->MA_NH }}" style="display: none;">
                                        <td> <input type="text" name='tenttct' disabled value="{{ $ttct->TEN_TTCT }}">
                                        </td>
                                        <td>
                    ...
                    <div class="form-group-inline text-center" style="display: inline; " id="giasp">
                        ...
                        <table style="margin-bottom: 18px">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <input type="text" id="price" name="gia_sp"
                                            style="max-width: 100px; margin-right: 27px;" class="form-control">
                                    </td>
                                    <td>
                                        <input type="number" min="1" id="sl" name="sl_sp"
                                            style="max-width: 86px;margin-right: 27px;" class="form-control">

                                    </td>
                                    <td>
                                        <input type="text" name="dvt" id="sl"
                                            style="max-width: 86px;margin-right: 47px;" class="form-control ">
                                    </td>
                                    <td>

                                        <div class="form-check-inline " style="margin-left: 10px; float: left;">
                                            <input class="form-check-input form-control-lg " type="radio" value="1"
                                                name="the_loai" id="the_loai">
                                            <label class="form-check-label" for="the_loai">
                                                Sản Phẩm Nổi Bật
                                            </label>
                                        </div>
                                        <div class="form-check-inline">
                                            <input class="form-check-input" type="radio" value="0" name="the_loai"
                                                id="the_loai">
                                            <label class="form-check-label" for="the_loai">
                                                Sản Phẩm Mới
                                            </label>
