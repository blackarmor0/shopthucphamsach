            ...
            <div class="position-center">
                <form role="form" action="them-moi-danh-muc-con" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="danhmuccon" id="exampleInputEmail1"
                            placeholder="Enter email">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Danh Mục Thuộc danh mục lớn nào</label>
                        <select class="form-control m-bot15" name="nganhhangchon"
