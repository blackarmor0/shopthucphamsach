...
<body>
    ...
    <div class="pd-wrap">
        <div class="container">
                ...
                <div class="col-md-6">
                    <div id="slider" class="owl-carousel product-slider">
                        ...
                        <img src="data:image/jpeg;base64,{{ $anh_sp->FILE_ANHSP }}" alt="Ảnh sản phẩm"
                            style="height: 600px;width: 600px;" class="img-fluid">
                        @endforeach
                    ...
                    <div class="product-dtl">
                        <div class="product-info">
                            ...
                            <div class="product-price-discount">
                                <span>{{ number_format($product->GIA_SP, 0, ',', '.') }}₫</span>
                            </div>
                        </div>
                        <div class="contener">
                            <div class="row">
            ...
            <div style="text-align:center;font-size:14px;padding-bottom:20px;">shop thực phẩm sạch chúc quý khách có
                những bữa ăn ngon miệng <a href="{{url('trang-chu')}}" target="_self"
                    style="color:#ff5e63;font-weight:bold;">Quay lại Trang Chủ</a></div>
        </div>
    </div>
    <script>
